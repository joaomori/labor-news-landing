        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#noticias" className="btn-accent inline-flex items-center gap-2">
                Ver Notícias
                <ArrowRight className="w-4 h-4" />
              </a>
              <button className="inline-flex items-center gap-2 text-primary-foreground border border-primary-foreground/30 px-6 py-3 rounded-md hover:bg-primary-foreground/10 transition-colors">
